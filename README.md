...
### Как это работает
Мод работает **по-разному** в зависимости от окружения:

#### **В одиночной игре:**
- **Команды работают** через чат
- **Обнаружение игроков** происходит локально
- **Данные кэшируются** на клиенте

#### **В мультиплеере:**
- **Команды работают** только на сервере
- **Обнаружение игроков** происходит на сервере
- **Данные кэшируются** на сервере
- **Статистика сохраняется** в файлы сервера

### Важные особенности
⚠️ **В мультиплеере команды работают только на сервере**  
⚠️ **Клиент не может выполнять команды мода**  
✅ **Все игроки могут использовать команды без прав OP**  
