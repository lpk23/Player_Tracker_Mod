...
## 🌐 Работа везде - полностью клиентский мод

### Как это работает
Мод работает **полностью на клиенте** через зону рендера:

#### **Автоматическое обнаружение:**
- **При каждом рендере HUD** мод сканирует зону вокруг игрока
- **FOV фильтр** - видит только игроков в поле зрения
- **Дистанция** - настраиваемая максимальная дистанция
- **Фильтрация NPC** - исключает ботов и невалидные никнеймы

#### **Автоматический HUD:**
- **Информация отображается** автоматически в игре
- **Список игроков** с расстоянием, направлением и биомом
- **Настраиваемое количество** отображаемых игроков
- **Режимы отображения** - компактный, детальный, минимальный

### Преимущества клиентского подхода
✅ **Работает везде** - и в одиночке, и в мультиплеере  
✅ **Автоматическое обнаружение** - не нужно вручную сканировать  
✅ **FOV фильтр** - видит только то, что видит игрок  
✅ **Производительность** - оптимизировано для клиента  
✅ **Безопасность** - не требует серверных прав  
✅ **Автоматический HUD** - информация всегда под рукой  
...
### Сервер
1. Установите NeoForge для Minecraft 1.21.7 на сервере
2. Поместите JAR файл мода в папку `mods` сервера
